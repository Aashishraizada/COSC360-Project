...
INSERT INTO `User` (firstName, lastName, email, phoneNum, address, city, state, postalCode, country, userName, password, isAdmin, enabled) VALUES ('Arnold', 'Anderson', 'a.anderson@gmail.com', '204-111-2222', '103 AnyWhere Street', 'Winnipeg', 'MB', 'R3X 45T', 'Canada', 'arnold' , 'test', 'no', 'yes');
INSERT INTO `User` (firstName, lastName, email, phoneNum, address, city, state, postalCode, country, userName, password, isAdmin, enabled) VALUES ('Bobby', 'Brown', 'bobby.brown@hotmail.ca', '572-342-8911', '222 Bush Avenue', 'Boston', 'MA', '22222', 'United States', 'bobby' , 'bobby', 'yes', 'yes');
INSERT INTO `User` (firstName, lastName, email, phoneNum, address, city, state, postalCode, country, userName, password, isAdmin, enabled) VALUES ('Candace', 'Cole', 'cole@charity.org', '333-444-5555', '333 Central Crescent', 'Chicago', 'IL', '33333', 'United States', 'candace' , 'password', 'no', 'yes');
INSERT INTO `User` (firstName, lastName, email, phoneNum, address, city, state, postalCode, country, userName, password, isAdmin, enabled) VALUES ('Darren', 'Doe', 'oe@doe.com', '250-807-2222', '444 Dover Lane', 'Kelowna', 'BC', 'V1V 2X9', 'Canada', 'darren' , 'pw', 'no', 'no');
INSERT INTO `User` (firstName, lastName, email, phoneNum, address, city, state, postalCode, country, userName, password, isAdmin, enabled) VALUES ('Elizabeth', 'Elliott', 'engel@uiowa.edu', '555-666-7777', '555 Everwood Street', 'Iowa City', 'IA', '52241', 'United States', 'beth' , 'test', 'no', 'yes');
